...
public class RegisterController {
    ...
    @PostMapping("/form")
    private String confirm(@Validated(UserForm.Groups.class) @ModelAttribute UserForm user, BindingResult result,
            Model model) {

        boolean hasError = usersRegisterService.isValid(user, result);
